#検索ワード100件をTwitter REST APIから取得
def getTweetData(search_word, max_id, since_id):
    ...
    if req.status_code == 200: #成功した場合
        ...
        return {"result":True, "metadata":metadata, "statuses":statuses, "limit":limit, "reset_time":datetime.datetime.fromtimestamp(float(reset)), "reset_time_unix":rest}
    else: #失敗した場合
